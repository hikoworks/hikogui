...
export module hikogui_SIMD : native_i32x4_sse2;
...
/** A int32_t x 4 (__m128i) SSE2 register.
 *
 *
...
struct native_simd<int32_t, 4> {
    ...
    {
        return native_simd{_mm_set1_epi32(a)};
    }
    ...
    {
        hi_axiom_bounds(b, sizeof(value_type) * CHAR_BIT);
        return native_simd{_mm_srai_epi32(a.v, b)};
    }
...
#ifdef HI_HAS_SSE4_1
        return native_simd{_mm_insert_epi32(a.v, b, Index)};
#else
    ...
    {
#ifdef HI_HAS_SSE4_1
        return _mm_extract_epi32(a.v, Index);
#else
